...
# For the BreedDetail and BreedList endpoints, I stuck to the non-generic class-based view 
...
class BreedList(APIView):
    """
        List all dog breeds, or create a new breed.
    """
...
# For the DogList and DogDetail methods, I tried using the generic mixin classes offered by the django rest_framework.
class DogList(APIView):
    """
        List all dogs, or create a new dog entry.
    """
    def get(self, request, format=None):
